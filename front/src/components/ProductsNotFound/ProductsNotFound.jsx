  ...
  return (
    <S.Wrapper>
      <S.ContainerNotProductsFound>
        <S.Icon
          class="ui-search-icon ui-search-icon--not-found ui-search-rescue__icon"
        ...
        <S.Tips>
          <S.Title>Não há anúncios que correspondem à sua busca.</S.Title>
          <S.List>
            <S.Item><strong>Revise a ortografia</strong> da palavra.</S.Item>
            <S.Item>Utilize <strong>palavras mais genéricas</strong> ou menos palavras.</S.Item>
          </S.List>
        </S.Tips>
      </S.ContainerNotProductsFound>
    </S.Wrapper>
